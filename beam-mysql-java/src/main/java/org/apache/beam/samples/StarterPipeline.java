...
import io.debezium.connector.postgresql.MySqlConnector;
...
public class StarterPipeline {
  public static void startDebeziumIOMySql() {
            ...
            DebeziumIO.<String>read()
                .withConnectorConfiguration(
                    DebeziumIO.ConnectorConfiguration.create()
                        ...
                        .withConnectionProperty("table.include.list", "inventory")
